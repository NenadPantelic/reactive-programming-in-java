package com.np.playground.tests.sec06;
...
public class CalculatorTest {
    ...
    public void calculator() {
        ...
        validate(20, 10, "@", 400, "the operation header must be sent in request: +-*/");
        validate(20, 10, null, 400, "the operation header must be sent in request: +-*/");
    }
