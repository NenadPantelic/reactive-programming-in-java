...
import com.np.playground.tests.sec07.dto.CalculatorResponse;
...
public class Lec06QueryParamsTest extends AbstractWebClient {
    ...
    @Test
    public void testUriBuilderVariables() {
    ...
    public void testUriBuilderMap() {
        ...
        this.client.get()
                .uri(builder -> builder.path(path).query(query).build(queryVariableMap))
                .retrieve()
                .bodyToMono(CalculatorResponse.class)
                .doOnNext(print())
                .then()
